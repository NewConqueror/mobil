...
Future<void> _showBackgroundNotification({
  ...
  const AndroidNotificationDetails androidDetails = AndroidNotificationDetails(
    ...
    'Ruh Hali Hatırlatmaları',
    channelDescription: 'Günlük ruh hali kontrolü için bildirimleri',
...
class NotificationService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      print('✅ Mood notification service initialized with AlarmManager');
  ...
  Future<void> _createNotificationChannel() async {
    const AndroidNotificationChannel mainChannel = AndroidNotificationChannel(
      'mood_reminder_channel',
      'Ruh Hali Hatırlatmaları',
      description: 'Günlük ruh hali kontrolü için bildirimleri',
      importance: Importance.max,
      playSound: true,
      enableVibration: true,
      enableLights: true,
    ...
    const AndroidNotificationChannel highPriorityChannel =
        AndroidNotificationChannel(
          'mood_high_priority',
          'Ruh Hali Yüksek Öncelik',
          description: 'Önemli ruh hali hatırlatmaları',
          importance: Importance.max,
          playSound: true,
          enableVibration: true,
          enableLights: true,
    ...
    const AndroidNotificationChannel backgroundChannel =
        AndroidNotificationChannel(
          'mood_background_service',
          'Ruh Hali Arka Plan Servisi',
          description: 'Ruh hali takibi arka plan servisi bildirimleri',
    ...
    for (int hour = 8; hour <= 23; hour++) {
      ...
      const AndroidNotificationDetails androidDetails =
          AndroidNotificationDetails(
            'mood_high_priority',
            'Ruh Hali Yüksek Öncelik',
            channelDescription: 'Önemli ruh hali hatırlatmaları',
            importance: Importance.max,
            priority: Priority.max,
            showWhen: true,
            enableVibration: true,
  ...
  Future<void> _showPersistentNotification() async {
    const AndroidNotificationDetails androidDetails =
        AndroidNotificationDetails(
          'mood_background_service',
          'Ruh Hali Arka Plan Servisi',
          channelDescription: 'Ruh hali takibi arka planda çalışıyor',
          importance: Importance.low,
